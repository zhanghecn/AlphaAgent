...
limit_up_preboard_point_day_scopes = Table(
    ...
    Column("eligible_for_model", Boolean, nullable=False),
    ...
    Column("audit_metrics", JSONB, nullable=False, server_default="{}"),
    Column("capture_runtime_fingerprint", String(80), nullable=True),
    Column(
    ...
    Column("formal_baseline_order_count", Integer, nullable=False, server_default="0"),
    Column("formal_baseline_orders", JSONB, nullable=False, server_default="[]"),
    Column("formal_baseline_orders_fingerprint", String(80), nullable=False),
    Column("input_fingerprint", String(80), nullable=False),
    Column("cohort_fingerprint", String(80), nullable=False),
...
Index(
    "ix_limit_up_preboard_point_day_scopes_status_date",
    limit_up_preboard_point_day_scopes.c.status,
    limit_up_preboard_point_day_scopes.c.trade_date,
)


limit_up_preboard_point_feature_rows = Table(
    ...
    Column("quote_observed_at", DateTime(timezone=True), nullable=True),
    Column("action_frame_eligible", Boolean, nullable=False),
    Column("action_previous_frame_gap_seconds", Float, nullable=True),
    Column("action_quote_coverage_ratio", Float, nullable=True),
    Column("action_market_timing_observed", Boolean, nullable=False),
    Column("formal_two_slot_observed", Boolean, nullable=False),
    Column("formal_two_slot_symbols", JSONB, nullable=False),
    ...
    Column("formal_identity_vt_symbol", String(32), nullable=True),
    Column("formal_event_at", DateTime(timezone=True), nullable=True),
    Column("frozen_at", DateTime(timezone=True), nullable=False, server_default=func.now()),
)
Index(
    "ix_limit_up_preboard_point_feature_rows_date_time",
    limit_up_preboard_point_feature_rows.c.contract_version,
    limit_up_preboard_point_feature_rows.c.trade_date,
    limit_up_preboard_point_feature_rows.c.captured_at,
)


limit_up_preboard_point_model_versions = Table(
    ...
    Column("validation_trade_dates", JSONB, nullable=False, server_default="[]"),
    Column("event_model_params", JSONB, nullable=False, server_default="{}"),
    Column("identity_model_params", JSONB, nullable=False, server_default="{}"),
    Column("action_model_params", JSONB, nullable=False, server_default="{}"),
    Column("frame_feature_fields", JSONB, nullable=False, server_default="[]"),
    Column("identity_feature_fields", JSONB, nullable=False, server_default="[]"),
    Column("action_feature_fields", JSONB, nullable=False, server_default="[]"),
    Column("training_input_fingerprint", String(80), nullable=False),
    Column("event_model_fingerprint", String(80), nullable=False),
    Column("identity_model_fingerprint", String(80), nullable=False),
    Column("action_model_fingerprint", String(80), nullable=False),
    Column("calibration_threshold", Float, nullable=True),
    Column("calibration_metrics", JSONB, nullable=False, server_default="{}"),
    Column("model_artifact", JSONB, nullable=False, server_default="{}"),
    Column("record_fingerprint", String(80), nullable=False),
    Column("frozen_at", DateTime(timezone=True), nullable=False),
    Column("created_at", DateTime(timezone=True), nullable=False, server_default=func.now()),
    UniqueConstraint(
        "contract_version",
        name="uq_limit_up_preboard_point_model_contract",
    ),
)
Index(
    "ix_limit_up_preboard_point_model_versions_status_frozen",
    limit_up_preboard_point_model_versions.c.contract_version,
    limit_up_preboard_point_model_versions.c.status,
    limit_up_preboard_point_model_versions.c.frozen_at,
)


limit_up_preboard_point_actions = Table(
    ...
    Column("contract_version", String(80), nullable=False),
    Column("trade_date", Date, nullable=False),
    Column("daily_slot", Integer, nullable=True),
    Column("portfolio_selected", Boolean, nullable=False, server_default="false"),
    Column("frame_id", BigInteger, nullable=False),
    Column("quote_observed_at", DateTime(timezone=True), nullable=True),
    Column("last_price", Float, nullable=True),
    Column("limit_price", Float, nullable=True),
    Column("action_probability", Float, nullable=False),
    Column("action_threshold", Float, nullable=False),
    Column("event_probability", Float, nullable=False),
    Column("identity_score", Float, nullable=False),
    Column("top1_margin", Float, nullable=True),
    ...
    Column("fill_status", String(40), nullable=False, server_default="pending"),
    Column("fill_at", DateTime(timezone=True), nullable=True),
    Column("fill_price", Float, nullable=True),
    Column("fill_quote_observed_at", DateTime(timezone=True), nullable=True),
    Column("settlement_evidence", JSONB, nullable=True),
    Column("settlement_evidence_fingerprint", String(80), nullable=True),
    Column("fill_closed_at", DateTime(timezone=True), nullable=True),
    Column("formal_identity_status", String(40), nullable=False, server_default="pending"),
    Column("formal_event_at", DateTime(timezone=True), nullable=True),
    Column("formal_identity_vt_symbol", String(32), nullable=True),
    Column("formal_identity_matched", Boolean, nullable=True),
    Column("original_two_slot_symbols", JSONB, nullable=False, server_default="[]"),
    Column("original_two_slot_matched", Boolean, nullable=True),
    Column("formal_identity_closed_at", DateTime(timezone=True), nullable=True),
    Column("physical_touch_status", String(40), nullable=False, server_default="pending"),
    Column("physical_touch_at", DateTime(timezone=True), nullable=True),
    Column("final_sealed", Boolean, nullable=True),
    Column("physical_touch_closed_at", DateTime(timezone=True), nullable=True),
    Column("d1_status", String(40), nullable=False, server_default="pending"),
    Column("d1_trade_date", Date, nullable=True),
    Column("d1_close_price", Float, nullable=True),
    Column("gross_return_pct", Float, nullable=True),
    Column("net_return_pct", Float, nullable=True),
    Column("double_cost_net_return_pct", Float, nullable=True),
    Column("d1_closed_at", DateTime(timezone=True), nullable=True),
    Column("created_at", DateTime(timezone=True), nullable=False, server_default=func.now()),
    CheckConstraint(
        "daily_slot IN (1, 2)",
        name="ck_limit_up_preboard_point_action_daily_slot",
    ),
    UniqueConstraint(
        "model_fingerprint",
        "trade_date",
        "daily_slot",
        name="uq_limit_up_preboard_point_action_daily_slot",
    ),
    UniqueConstraint(
        "model_fingerprint",
        "trade_date",
        "vt_symbol",
        name="uq_limit_up_preboard_point_action_stock_day",
    ),
)
Index(
    "ix_limit_up_preboard_point_actions_date_status",
    limit_up_preboard_point_actions.c.contract_version,
    limit_up_preboard_point_actions.c.trade_date,
    limit_up_preboard_point_actions.c.d1_status,
)


limit_up_transaction_pair_manifests = Table(
    "limit_up_transaction_pair_manifests",
    metadata,
    Column("manifest_version", String(80), primary_key=True),
    Column("session_count", Integer, primary_key=True),
    Column("start_date", Date, primary_key=True),
    Column("end_date", Date, primary_key=True),
    Column("status", String(24), nullable=False),
    Column("strategy_filter_version", String(80), nullable=False),
    Column("feature_version", String(64), nullable=False),
    Column("input_fingerprint", String(80), nullable=False),
    Column("manifest_pair_count", Integer, nullable=False),
    Column("complete_minute_pair_count", Integer, nullable=False),
    Column("static_upper_bound_pair_count", Integer, nullable=False),
    Column("shared_pair_count", Integer, nullable=False),
    Column("shared_prefix_count", Integer, nullable=False),
    Column("pairs", JSONB, nullable=False, server_default="[]"),
    Column("filter_audit", JSONB, nullable=False, server_default="{}"),
    Column("feature_coverage", JSONB, nullable=False, server_default="{}"),
    Column("created_at", DateTime(timezone=True), nullable=False, server_default=func.now()),
)
Index(
    "ix_limit_up_transaction_pair_manifests_end",
    limit_up_transaction_pair_manifests.c.end_date,
)


limit_up_transaction_feature_scopes = Table(
    ...
    Column("status", String(24), nullable=False),
    Column("source", String(160), nullable=False),
    Column("source_host", JSONB, nullable=False, server_default="{}"),
    Column("page_count", Integer, nullable=False, server_default="0"),
    Column("raw_row_count", Integer, nullable=False, server_default="0"),
    Column("trade_row_count", Integer, nullable=False, server_default="0"),
    Column("pagination_complete", Boolean, nullable=False, server_default="false"),
    Column("first_time", String(5), nullable=True),
    Column("last_time", String(5), nullable=True),
    Column("volume_matches", Boolean, nullable=False, server_default="false"),
    Column("observed_volume", Float, nullable=True),
    Column("expected_volume", Float, nullable=True),
    Column("volume_difference", Float, nullable=True),
    Column("close_difference", Float, nullable=True),
    Column("high_difference", Float, nullable=True),
    Column("low_difference", Float, nullable=True),
    Column("price_audit_status", String(24), nullable=True),
    Column("input_fingerprint", String(80), nullable=False),
    Column("feature_row_count", Integer, nullable=False, server_default="0"),
    Column("raw", JSONB, nullable=False, server_default="{}"),
    Column("created_at", DateTime(timezone=True), nullable=False, server_default=func.now()),
...
Index(
    "ix_limit_up_transaction_feature_scopes_date_status",
    limit_up_transaction_feature_scopes.c.trade_date,
    limit_up_transaction_feature_scopes.c.status,
)


limit_up_transaction_features = Table(
    ...
    Column("input_fingerprint", String(80), nullable=False),
    Column("source", String(160), nullable=False),
    Column("values", JSONB, nullable=False, server_default="{}"),
    Column("created_at", DateTime(timezone=True), nullable=False, server_default=func.now()),
)
Index(
    "ix_limit_up_transaction_features_symbol_date",
    limit_up_transaction_features.c.vt_symbol,
    limit_up_transaction_features.c.trade_date,
)
...
def _apply_compatible_schema_patches(engine) -> None:
    ...
    patches = (
        ...
        "ALTER TABLE limit_up_preboard_point_feature_rows ADD COLUMN IF NOT EXISTS action_frame_eligible BOOLEAN",
        "ALTER TABLE limit_up_preboard_point_feature_rows ADD COLUMN IF NOT EXISTS action_previous_frame_gap_seconds FLOAT",
        "ALTER TABLE limit_up_preboard_point_feature_rows ADD COLUMN IF NOT EXISTS action_quote_coverage_ratio FLOAT",
        ...
        "ALTER TABLE limit_up_preboard_point_day_scopes ADD COLUMN IF NOT EXISTS formal_baseline_orders JSONB NOT NULL DEFAULT '[]'::jsonb",
        "ALTER TABLE limit_up_preboard_point_day_scopes ADD COLUMN IF NOT EXISTS formal_baseline_orders_fingerprint VARCHAR(80) NOT NULL DEFAULT 'sha256:4f53cda18c2baa0c0354bb5f9a3ecbe5ed12ab4d8e2a0d47d6d93f9dcfe6e6f8'",
        "ALTER TABLE limit_up_preboard_point_actions ADD COLUMN IF NOT EXISTS daily_slot INTEGER",
        "ALTER TABLE limit_up_preboard_point_actions ADD COLUMN IF NOT EXISTS portfolio_selected BOOLEAN NOT NULL DEFAULT false",
        "UPDATE limit_up_preboard_point_actions SET portfolio_selected = true WHERE daily_slot IS NOT NULL AND portfolio_selected = false",
        "ALTER TABLE limit_up_preboard_point_actions ADD COLUMN IF NOT EXISTS settlement_evidence JSONB",
        "ALTER TABLE limit_up_preboard_point_actions ADD COLUMN IF NOT EXISTS settlement_evidence_fingerprint VARCHAR(80)",
        "ALTER TABLE limit_up_preboard_point_actions ALTER COLUMN daily_slot DROP NOT NULL",
        "DO $$ BEGIN IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'ck_limit_up_preboard_point_action_daily_slot') THEN ALTER TABLE limit_up_preboard_point_actions ADD CONSTRAINT ck_limit_up_preboard_point_action_daily_slot CHECK (daily_slot IN (1, 2)); END IF; END $$",
        "CREATE UNIQUE INDEX IF NOT EXISTS uq_limit_up_preboard_point_action_daily_slot ON limit_up_preboard_point_actions (model_fingerprint, trade_date, daily_slot)",
        "CREATE UNIQUE INDEX IF NOT EXISTS uq_limit_up_preboard_point_action_stock_day ON limit_up_preboard_point_actions (model_fingerprint, trade_date, vt_symbol)",
        "CREATE UNIQUE INDEX IF NOT EXISTS uq_limit_up_preboard_point_model_contract ON limit_up_preboard_point_model_versions (contract_version)",
