...
PERSONAL_RESEARCH_CASES = (
    ...
    # 2026-08 趋势族重构（08-17 涨停确认制定稿）。
    # A 补涨涨停（N 字板稳定版，3 个涨停日案例）
    ("华电辽能 补涨涨停", "600396.SSE", date(2026, 4, 22), "trend_pullback"),
    ("福达合金 补涨涨停", "603045.SSE", date(2026, 6, 15), "trend_pullback"),
    ("九牧王 补涨涨停", "601566.SSE", date(2025, 12, 18), "trend_pullback"),
    # 观察层：连板回落低吸日（8 个原 A 案例，补涨涨停的预备窗口）
