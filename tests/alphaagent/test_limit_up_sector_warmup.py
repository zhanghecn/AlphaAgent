...
def _research_candidate(
    ...
    *,
    ...
    return {
        ...
        "outcome": {
            "sealed": sealed,
            "next_open_return_pct": gross_return_pct,
        },
    }
...
def test_live_repository_aggregates_overlapping_concepts_into_one_context():
    ...
    flows = {
        "BK001": {"main_net_inflow": 2_000_000_000.0, "main_net_inflow_ratio": 4.0},
        "BK002": {"main_net_inflow": 1_000_000_000.0, "main_net_inflow_ratio": 2.0},
    }
