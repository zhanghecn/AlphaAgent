...
def test_real_touch_quality_action_uses_formal_quality_contract() -> None:
    signal = {
        "vt_symbol": "600001.SSE",
        "board_lane": "two_to_three",
        "action": "buy_now",
...
def test_real_touch_cannot_bypass_public_quality_failure() -> None:
    signal = {
        "vt_symbol": "600001.SSE",
        "board_lane": "two_to_three",
        "action": "buy_now",
...
def test_live_portfolio_requires_formal_selection() -> None:
    recommendations = {
        "lanes": {
            "now": [
                {
...
def test_radar_capture_excludes_below_three_auction_watch_stock() -> None:
...
def test_refresh_persists_internal_radar_ledger_without_public_leak(monkeypatch) -> None:
    ...
    assert persistence_events == ["save"]
    assert persisted == [result]
