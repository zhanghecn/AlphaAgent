  ...
  return [
    ...
    },
    {
      ...
      bullets: [
        ...
        "交叉指引：二板反包打板打法（盘中 +7% 触发、不板必走、板留断走）已独立成产品线——见短线研究「趋势弱转强」页签，与本页趋势族「涨停弱转强 P1.5」（低吸持有、打板预备语义）不是同一打法",
      ],
    },
    {
      key: "scoring",
...
const TREND_RULE_NODES: GuideRuleNode[] = [
  ...
  },
  {
    ...
    family: "trend_pullback",
    shortLabel: "弱转强预备（盘中雷达）",
    tier: "product",
    conditions: [
      "近 60 交易日内存在 ≥4 连板的主段",
      "主段段顶后 ≤3 个交易日内（破坏后的承接窗）",
      "换手 ≥8%（承接活跃）且当前未封涨停",
      "深水承接拉起：现价脱离当日低点 ≥4pct，或盘中低点深水（≤ 昨收 -6%）",
    ],
    evidence:
      "B 涨停弱转强的盘中前奏：实时推荐在盘中快照提前展示（标注「弱转强预备·未封板」），让用户准备打板——封板瞬间升级为 B 规则确认信号。收盘未涨停的同形态全市场两年为负边缘（37~42%/−1.3~−2.0），因此 15:01 定格与确认版/回测一律剔除，绝不当作买点。主人 9 个案例（哈药/航天 11-27/科森 8-26/传智/安记/梦天/锋龙/兴业/爱丽）是它的形态本体。",
    chartHint:
      "对照看案例 K 线：深水拉起进行中是预告，收盘封板才是确认——不封板的同形态大多次日继续跌",
  },
];
