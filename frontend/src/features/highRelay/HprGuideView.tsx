...
const GROUP_STYLES: Record<string, { badge: string; label: string }> = {
  ...
  A2: { badge: "bg-amber-500/15 text-amber-500", label: "A2" },
  B1: { badge: "bg-primary/15 text-primary", label: "B1" },
  B2: { badge: "bg-orange-500/15 text-orange-500", label: "B2" },
  B3: { badge: "bg-violet-500/15 text-violet-500", label: "B3" },
...
const POINT_ORDER = ["A1", "A2", "B1", "B2", "B3"] as const;
