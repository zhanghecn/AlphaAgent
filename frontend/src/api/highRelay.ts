...
// 策略口径 = hpr-v3.0 连板链组合十方案(量化因子研究/高位接力/汇总/连板链组合总结.md,2026-09-26定稿)。
// 买点 = 昨日恰好2/3连板,链区间(前几板开盘%+二板换手窗)命中且今天开盘在方案窗内,
// 触涨停价即打(无时间窗);开盘≥9.5%顶格不命中(正常开盘口径)。
// 池 = 昨日2/3连板全量(雷达),十方案 A1/A2/A3(二接三阳) B1/B2(二接三阴) C1/C2(三接四阳) D1/D2/D3(三接四阴)。
