...
- 板前概率、提前推荐、独立观察池、训练/评分模型、冻结结算任务和页面榜单已全部移除，
  不存在可晋级或兼容回退的旧合同。
- 3% 雷达只保存原始行情、概念、资金和历史点时数据，不生成概率、候选、动作或买点。
...
- 2026 年 3-6 月有完整日线但没有历史点时题材成员和盘中板块资金，只能做日级轮换。
  严格概念历史当前只有 7 月 17、20 两个 validation 日；7 月 21-28 日虽有点时成员和
  概念帧，但只属于自然前向案例，尚无足够闭合标签。
