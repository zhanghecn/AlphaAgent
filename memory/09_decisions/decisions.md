...
- `/limit-up` 产品主回测固定为 10 万元、4 仓共享现金账户，默认 D+1 收盘退出，只执行首板、二进三和高板；一进二因滚动样本外持续负贡献仅保留独立研究。600 日全历史为 243 笔闭合交易、`61.7284% / +203.7969% / -10.3577%`，滚动样本外为 128 笔、`57.8125% / +102.1356% / -10.3577%`，锁定留出仅作验证且为 114 笔、`65.7895% / +46.6206% / -6.3783%`。旧日等权结果只显示为信号研究上界；冻结后前向仍为 0，因此继续 `research_only / simulation_eligible=false`。
