...
| --- | --- | --- | --- | --- |
| `market_phase` | `rotation` | 22 / +59.0909% / +1.1910% | 20 / +80.0000% / +2.2204% | `false` |
| `market_phase` | `warming` | 23 / +78.2609% / +2.9028% | 21 / +71.4286% / +3.4046% | `true` |
| `dynamic_rank` | `1` | 23 / +69.5652% / +2.1012% | 18 / +72.2222% / +3.3651% | `true` |
| `dynamic_rank` | `2` | 11 / +63.6364% / +2.1917% | 12 / +66.6667% / +2.1069% | `true` |
| `dynamic_rank` | `3` | 11 / +72.7273% / +1.8664% | 11 / +90.9091% / +2.7319% | `true` |
| `wave_number` | `1` | 33 / +72.7273% / +2.3949% | 24 / +70.8333% / +2.9741% | `true` |
| `wave_number` | `2` | 7 / +42.8571% / +0.0860% | 9 / +88.8889% / +2.3264% | `false` |
| `wave_number` | `3` | 4 / +75.0000% / +0.8713% | 3 / +33.3333% / -3.3860% | `false` |
| `wave_number` | `4` | 0 / null / null | 1 / +100.0000% / +0.6850% | `false` |
| `wave_number` | `5` | 1 / +100.0000% / +9.8467% | 1 / +100.0000% / +9.7572% | `true` |
| `wave_number` | `6` | 0 / null / null | 2 / +100.0000% / +6.7571% | `false` |
| `wave_number` | `7` | 0 / null / null | 1 / +100.0000% / +9.7910% | `false` |
| `support_line` | `ma10` | 31 / +67.7419% / +1.8706% | 27 / +77.7778% / +3.1825% | `true` |
| `support_line` | `ma20` | 9 / +77.7778% / +3.6834% | 11 / +81.8182% / +3.0048% | `true` |
| `support_line` | `ma5` | 5 / +60.0000% / +0.3659% | 3 / +33.3333% / -1.0249% | `false` |
| `support_test_session_gap` | `1` | 38 / +68.4211% / +1.8490% | 32 / +75.0000% / +2.4126% | `true` |
| `support_test_session_gap` | `2` | 7 / +71.4286% / +3.2438% | 9 / +77.7778% / +4.3001% | `true` |
...
- 全历史：`81` 笔，胜率 `+75.3086%`，均值 `+2.8227%`，PF `3.9169`
- 开发段：`43` 笔，胜率 `+72.0930%`，均值 `+2.5277%`，PF `3.2334`
- 复用验证：`38` 笔，胜率 `+78.9474%`，均值 `+3.1566%`，PF `5.0362`
- 四仓现金：`79` 笔，胜率 `+74.6835%`，复利 `+74.1073%`，回撤 `-4.0879%`
- 历史资格门：`historical_candidate_rejected`；失败门：`sequential_cross_regime_failed`。
