...
- `/limit-up` 是独立的主板打板研究，不属于 `mainline_dragon_pullback` 基线。`limit-up-history-v10` 覆盖 600 个交易日，按“战法多样化后排名”每日等权选择 0-4 只：空仓 398 日、1/2/3/4 只分别 33/35/24/110 日，共 615 只。二进三 D+1 收盘闭合 76 笔、覆盖 60 日，胜率 `65.79%`、平均 `+3.3587%`、日等权复利 `+499.18%`、回撤 `-30.13%`；A 级 31 笔为 `74.19% / +4.3424%`，四项以上风险栈池 3,004 笔仅 `40.71% / -1.0812%`。首板多选和一进二没有改善，冻结后前向仍为 0；四战法均为 `research_only`、`simulation_eligible=false`，逐日行业成员仍为 0 日且无 Tick/L2，详见 `limit_up_short_term_factor_research.md`。
