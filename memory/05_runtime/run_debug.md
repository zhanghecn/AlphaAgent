...
- 本地运行数据已自然推进到 `2026-07-28` 的 808 个可靠交易日。
- A+B+C v2 当前闭合 140 笔，`96/140=68.5714%`、平均 `+2.0988%`、独立信号复利
  `+687.9533%`、最大回撤 `-21.0357%`。两仓成交 94 笔、`69/94=73.4043%`、
  平均 `+2.4371%`、复利 `+195.3585%`、回撤 `-8.8761%`。自然前向从新 v2
  有效交易日起算，状态是
...
2026-07-29 确定性板前榜修复后，限涨停后端 `801 passed`、前端 `143 passed`；生产构建和
`git diff --check` 均通过。Compose 默认只运行 API 与统一 data-sync worker；
